                        ...
                        <div className="card flex-shrink-0  shadow-2xl bg-base-100">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="form-control">
                                    ...
                                    <div className='flex '>
                                        <input  name="fname" type="text" placeholder="First Name" className="input input-bordered mr-5" />
                                ...
                                <div className="form-control">
                                    ...
                                    <select name='role' className="select select-accent bg-slate-300 w-full max-w-xs">
                                ...
                                <div className="form-control">
                                    ...
                                    <input name="nid" type="text" placeholder="Nid" className="input input-bordered" />
                                </div>
                                <div className="form-control">
                                    <label className="label">
